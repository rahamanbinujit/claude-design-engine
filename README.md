...
### Your AI Creative Director. Designs anything. From your terminal.
...
```markdown
## Design System
For any design task, read and follow the skill at `claude-design-engine/SKILL.md`.
```
...
**Then just say:** `"Design a LinkedIn post about [your topic]"`
...
<table>
<tr>
<td><img src="examples/showcase/photo-integrated-poster.png" width="260" alt="Photo-integrated poster with AI-generated imagery"></td>
<td><img src="examples/showcase/organic-notebook-post.png" width="260" alt="Organic notebook style with handwritten fonts and sticky notes"></td>
<td><img src="examples/showcase/carousel-hook-organic.png" width="260" alt="Carousel hook slide with strikethrough text"></td>
<td><img src="examples/showcase/stats-poster-dark.png" width="260" alt="Stats poster with giant 91% number"></td>
</tr>
<tr>
<td align="center"><em>Photo + AI Image<br>Dark Editorial</em></td>
<td align="center"><em>Organic Notebook<br>Handwritten + Sticky Notes</em></td>
<td align="center"><em>Carousel Hook<br>Strikethrough Technique</em></td>
<td align="center"><em>Giant Stat<br>Data-Driven Post</em></td>
</tr>
</table>
...
<table>
<tr>
<td><img src="examples/showcase/presentation-slide.png" width="480" alt="Comparison slide - AI Chatbots vs Agentic AI"></td>
<td><img src="examples/showcase/diagram-slide.png" width="480" alt="System architecture diagram with connected components"></td>
</tr>
<tr>
<td align="center"><em>Comparison Slide — Split Layout</em></td>
<td align="center"><em>System Diagram — Connected Architecture</em></td>
</tr>
</table>
...
## Full Setup & Cross-Agent Support
...
Free API key from [Google AI Studio](https://aistudio.google.com/apikey). **Key stays local — never committed to git.**
